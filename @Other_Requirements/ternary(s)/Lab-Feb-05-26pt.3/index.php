...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4 mt-4">
        ...
        <div class="md my-4">
            ...
            <?= $index % 2 === 0 ? '<div class="bg-sky-50 rounded-lg shadow-md">': '<div class="bg-blue-100 rounded-lg shadow-md">' ?>
                ...
                <div class="p-4">
                    ...
                    <ul class="mt-4">
                        ...
                        <li class="mb-2">
                            ...
                            <?= $job['location']==='Japan'? '<span class="text-xs text-white bg-sky-500 rounded-full px-2 py-1 ml-2">Remote</span>':
                            '<span class="text-xs text-white bg-sky-500 rounded-full px-2 py-1 ml-2">On Site</span>' ?>
